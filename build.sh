...
mkdir win32
pushd win32
mingw32-cmake .. -DBUILD_SHARED=OFF -DCMAKE_EXE_LINKER_FLAGS=-static -DCMAKE_BUILD_TYPE=Release -DQT_INCLUDE_DIRS_NO_SYSTEM=ON
make -j5
...
mkdir win64
pushd win64
mingw64-cmake .. -DBUILD_SHARED=OFF -DCMAKE_EXE_LINKER_FLAGS=-static -DCMAKE_BUILD_TYPE=Release -DQT_INCLUDE_DIRS_NO_SYSTEM=ON
make -j5
version=$(cat appversion)
